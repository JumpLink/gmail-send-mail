...
paths.browser.fonts =  [paths.browser.root + 'fonts/*', paths.browser.root + 'third-party/components-font-awesome/fonts/*'];
paths.browser.images =  paths.browser.root + 'images/*';
paths.browser.stylesRoot = paths.browser.root + 'style/';
paths.browser.styles = [paths.browser.stylesRoot + '*.less', paths.browser.stylesRoot + '*/*.less'];
